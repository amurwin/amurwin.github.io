                      ...
                      <CarouselItem key={index} className="relative">
                        ...
                        <div className="absolute inset-0 mx-auto flex flex-col items-center justify-center gap-5 px-10 font-bold sm:text-2xl dark:text-white">
                          ...
                          <a
                            href={paper.href}
                            download
                            className="flex cursor-pointer items-center gap-2 rounded-lg bg-accent-500 px-4 py-2 text-sm text-white hover:bg-accent-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black dark:focus-visible:outline-white dark:bg-accent-600 dark:hover:bg-accent-800"
                          >
                            ↓ Download
                          </a>
                        </div>
